...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, default="eval/motion_fidelity/configs/motion_fidelity_score_config.yaml")
    ...
    print(similarity_scores_dict["average_score"])
